...
1. TEST DATA STRUCTURE:
   ...
   - input_data.lfp_data: LFP data (if available) as 2D array [channels × samples]
...
3. API USAGE:
   ...
   - AlgorithmOutput: Return this object with your results
     Example:             # Visualization data will be automatically determined based on output_data keys
            # For custom visualization, add specific keys to output_data:
            # - spike_times: for raster plots
            # - signal_data: for raw signal plots
            # - freqs and power: for power spectrum
            # - spectrogram: for spectrogram
            # - psth_counts and bin_centers: for PSTH
            # - labels and cluster_centers: for spike sorting
            # - conditions and mean_responses: for tuning curves 
        return AlgorithmOutput(data={...}, success=True, error_message="")
