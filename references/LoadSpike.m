...
offset=332-CurrPos;
fseek(SpikeID, offset, 'cof');
%%%%%
% fseek(SpikeID, 256, 'cof');220425de
%%%%%%%
% SpikeBasic.SoftwareVersion = sprintf('%s', fread(SpikeID, 32, 'uint8=>char'));
% % fseek(SpikeID, 32, 'cof');
% SpikeBasic.Comment = sprintf('%s', fread(SpikeID, 256, 'uint8=>char'));
